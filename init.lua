...
-- Statusline colors
vim.api.nvim_set_hl(0, "StatusLine", { bg = "#d0d0d0", fg = "#000000", bold = false })
vim.api.nvim_set_hl(0, "StatusLineNC", { bg = "#b8b8b8", fg = "#000000", bold = false })
vim.api.nvim_set_hl(0, "StatusLineBold", { bg = "#d0d0d0", fg = "#000000", bold = true })
-- Transparent tabline
vim.cmd([[
